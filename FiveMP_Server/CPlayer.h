...
public:
	...
	Vector3					m_vecForward;
	bool					m_bHasAim;
	Vector3					m_vecAimPos; // server's version of the player aiming.
	...
	void StoreAimSyncData(Vector3 * pAim);
	...
	void		SetCurrentWeapon(UINT32 weaponHash) { m_curWeaponHash = weaponHash; }
