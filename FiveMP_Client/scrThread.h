...
#if 0
		char msg[128];
		sprintf(msg, "%d", cxt.GetResult<R>());
		MessageBoxA(GetForegroundWindow(), "Executed Native", msg, 0);
#endif
...
public:
	...
	*/
	...
	//virtual ~GtaThread()					 												{} //This is new 3-23-2016
	virtual eThreadState Reset(UINT32 scriptHash, void* pArgs, UINT32 argCount) = 0;
	...
	inline char* GetScriptName() { return scriptName; }
};
...
typedef struct {
public:
	void(*Deconstructor)(GtaThread* This); //This is now disabled - 3-23-2016
